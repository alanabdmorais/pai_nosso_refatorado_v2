...
class PipelineConfig:
    ...
    def pasta_drive_correcoes(self) -> Path:
        ...
        return Path(f"/content/drive/MyDrive/pai_nosso_refatorado_v2/pipeline/correcoes/{self.NOME_ORACAO}")

    @property
    def pasta_drive_brutos(self) -> Path:
        """Onde o pipeline salva os JSONs brutos gerados pelo Groq."""
        return Path(f"/content/drive/MyDrive/pai_nosso_refatorado_v2/pipeline/brutos/{self.NOME_ORACAO}")
